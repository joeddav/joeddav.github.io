...
excerpt: State-of-the-art NLP models for text classification without annotated data. See the live demo on HF spaces.
comments: false
---

## State-of-the-art NLP models for text classification without annotated data.

*Original post (with reader comments) on legacy site [here](https://joeddav.github.io/blog/2020/05/29/ZSL.html)*

> Check out our live [zero-shot topic classification demo here](https://huggingface.co/spaces/joeddav/zero-shot-demo).
...
See [our live demo here](https://huggingface.co/spaces/joeddav/zero-shot-demo) to try it out for yourself! Enter a sequence you want to classify and any labels of interest and watch Bart do its magic in real time.
